      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Quanto mais você investe em sua saúde, mais economiza. 
            Todos os pacotes incluem frete grátis e garantia de 90 dias.
          </p>
        </div>
            ...
            >
              ...
              <CardHeader className="text-center pb-8">
                <div className="relative w-32 h-32 mx-auto mb-4">
                  <img 
                    src={productImage} 
                    alt={`${option.bottles} frasco(s) de Mitolyn`}
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm font-semibold text-success">
                    ${option.perBottle} por frasco
                  </p>
                  <p className="text-xs text-muted-foreground">
                    Economize ${option.savings}
                  </p>
                </div>
              </CardHeader>
              ...
              <CardContent className="flex-1">
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-success shrink-0 mt-0.5" />
                    <span className="text-sm">100% Satisfação</span>
                  </li>
                  {option.bottles >= 3 && (
                    <>
                      <li className="flex items-start gap-2">
                        <Check className="w-5 h-5 text-success shrink-0 mt-0.5" />
                        <span className="text-sm font-semibold text-primary">2 E-books Grátis</span>
                      </li>
                    </>
                  )}
                  {option.bottles >= 6 && (
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-success shrink-0 mt-0.5" />
                      <span className="text-sm font-semibold text-primary">Suporte Priority</span>
                    </li>
                  )}
                </ul>
              </CardContent>
        ...
        <div className="text-center mt-12 space-y-4">
          <div className="flex items-center justify-center gap-8 flex-wrap text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-muted-foreground">Pagamento Seguro SSL</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none">
